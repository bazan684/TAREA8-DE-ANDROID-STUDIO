    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnMostrar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String url = "https://aqua-gazelle-640324.hostingersite.com/volleycrud/recuperar_producto.php?idproducto=" + idproducto;
                recuperarData(url);
            }
        });
        ...
        btnAgregar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String url = "https://aqua-gazelle-640324.hostingersite.com/volleycrud/insertar_producto.php?nombre="
                        + nombre + "&precio="
        ...
        btnModificar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String url = "https://aqua-gazelle-640324.hostingersite.com/volleycrud/modificar_producto.php?nombre="
                        + nombre + "&precio="
                        + precio + "&cantidad=" + cantidad
        ...
        btnEliminar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                idproducto = etID.getText().toString().trim();
                String url = "https://aqua-gazelle-640324.hostingersite.com/volleycrud/eliminar_producto.php?idproducto="
                        + idproducto;
                guardarData(url);
